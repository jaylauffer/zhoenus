...
public class Zhoenus : ModuleRules
{
	public Zhoenus(ReadOnlyTargetRules Target) : base(Target)
	{
		PCHUsage = PCHUsageMode.UseExplicitOrSharedPCHs;
                ...
                PublicDependencyModuleNames.AddRange(new string[] { "Core", "CoreUObject", "Engine", "EngineSettings", "InputCore", "UMG", "Slate", "SlateCore", "Niagara", "MetasoundEngine", "AudioExtensions", "EnhancedInput", "CommonUI" });
