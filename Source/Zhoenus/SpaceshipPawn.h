...
public:
	...
	UPROPERTY(EditAnywhere, Category = "Flight|Kinematic")
	float KinematicMassKg = 1000.f;
	...
	void StartFireInput(const FInputActionValue& Value);
	void StopFireInput();
    ...
    float MouseStickSensitivity = 0.01f;    // px → axis units

    UPROPERTY(EditAnywhere, Category="Input|MouseStick")
    float MouseStickDecay = 0.1f;            // 0 = sticky; >0 = spring to 0
...
public:
	...
	/** How quickly reverse speed changes */
	UPROPERTY(Category = Plane, EditAnywhere)
